...
require (
	...
	google.golang.org/api v0.188.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20240708141625-4ad9e859172b // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.18.3 // @grafana/backend-platform
