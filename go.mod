...
require (
	...
	golang.org/x/time v0.10.0 // @grafana/backend-platform
	...
	google.golang.org/api v0.222.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20250122153221-138b5a5a4fd4 // indirect; @grafana/backend-platform
)
