...
require (
	...
	google.golang.org/api v0.184.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20240604185151-ef581f913117 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.18.0 // @grafana/backend-platform
